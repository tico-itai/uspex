...
lat_basic1 = MattoVec(POP_STRUC.lat);
USPEX_STRUC.GENERATION(generation).lat_basic = lat_basic1;
[nothing, nothing] = unix(['echo ' num2str(lat_basic1,'%12.4f ') '  >> ' resFolder '/lattice_basic.dat']);
if varcomp
if sum(POP_STRUC.POPULATION(IND).superCell) == 3 
