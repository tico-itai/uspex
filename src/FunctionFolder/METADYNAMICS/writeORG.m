...
fp = fopen(fpath, 'a+');
description    = 'Evolutionary Metadynamics Code for Structure Prediction';
...
text = {'Zhu Q., Oganov A.R., Lyakhov A.O. (2011)', ...
'Evolutionary metadynamics: A novel method to predict crystal structures.',  ...
'CrystEngComm, 14, 3596-3601', ...
'', ...
'Zhu, Q., Oganov, A.R., Lyakhov, A.O., and Yu, X. (2015)', ...
'Generalized evolutionary metadynamics for sampling', ...
'the energy landscapes and its applications.', ...
'Phys. Rev. B, 92, 024106' ...
};
