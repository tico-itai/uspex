...
D((a-1)*3+1, (b-1)*3+1) = D((a-1)*3+1, (b-1)*3+1) - H*cos_x*cos_x; 
D((a-1)*3+1, (b-1)*3+2) = D((a-1)*3+1, (b-1)*3+2) - H*cos_x*cos_y; 
D((a-1)*3+1, (b-1)*3+3) = D((a-1)*3+1, (b-1)*3+3) - H*cos_x*cos_z; 
...
D((a-1)*3+2, (b-1)*3+1) = D((a-1)*3+2, (b-1)*3+1) - H*cos_y*cos_x; 
D((a-1)*3+2, (b-1)*3+2) = D((a-1)*3+2, (b-1)*3+2) - H*cos_y*cos_y; 
D((a-1)*3+2, (b-1)*3+3) = D((a-1)*3+2, (b-1)*3+3) - H*cos_y*cos_z; 
...
D((a-1)*3+3, (b-1)*3+1) = D((a-1)*3+3, (b-1)*3+1) - H*cos_z*cos_x; 
D((a-1)*3+3, (b-1)*3+2) = D((a-1)*3+3, (b-1)*3+2) - H*cos_z*cos_y; 
D((a-1)*3+3, (b-1)*3+3) = D((a-1)*3+3, (b-1)*3+3) - H*cos_z*cos_z; 
...
D((b-1)*3+1, (a-1)*3+1) = D((b-1)*3+1, (a-1)*3+1) - H*cos_x*cos_x; 
D((b-1)*3+1, (a-1)*3+2) = D((b-1)*3+1, (a-1)*3+2) - H*cos_x*cos_y; 
D((b-1)*3+1, (a-1)*3+3) = D((b-1)*3+1, (a-1)*3+3) - H*cos_x*cos_z; 
...
D((b-1)*3+2, (a-1)*3+1) = D((b-1)*3+2, (a-1)*3+1) - H*cos_y*cos_x; 
D((b-1)*3+2, (a-1)*3+2) = D((b-1)*3+2, (a-1)*3+2) - H*cos_y*cos_y; 
D((b-1)*3+2, (a-1)*3+3) = D((b-1)*3+2, (a-1)*3+3) - H*cos_y*cos_z; 
...
D((b-1)*3+3, (a-1)*3+1) = D((b-1)*3+3, (a-1)*3+1) - H*cos_z*cos_x; 
D((b-1)*3+3, (a-1)*3+2) = D((b-1)*3+3, (a-1)*3+2) - H*cos_z*cos_y; 
D((b-1)*3+3, (a-1)*3+3) = D((b-1)*3+3, (a-1)*3+3) - H*cos_z*cos_z; 
end 
if it == N_bonds
break;
end
