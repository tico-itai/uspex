...
[nothing, nothing] = unix(['rm -f ' ORG_STRUC.resFolder '/BarrierFigure.tif']);
[nothing, nothing] = unix(['rm -f ' ORG_STRUC.resFolder '/SelectedEnergyBarrier.tif']);
[nothing, nothing] = unix(['rm -f ' ORG_STRUC.resFolder '/EnergyBarrier_vs_Step.tif']);
x=1:numImages;
y=zeros(1,numImages);
for i = 1:numImages
