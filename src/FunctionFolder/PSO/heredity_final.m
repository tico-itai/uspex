...
if (par_one == 0) 
parent1 = POP_STRUC.PSO(POP_STRUC.bestPSOstruc).coordinates;
lat1 = POP_STRUC.PSO(POP_STRUC.bestPSOstruc).lattice;
order1 = POP_STRUC.PSO(POP_STRUC.bestPSOstruc).order;
numIons1 = POP_STRUC.PSO(POP_STRUC.bestPSOstruc).numIons;
else
parent1 = POP_STRUC.PSO(par_one).coordinates;
lat1 = POP_STRUC.PSO(par_one).lattice;
order1 = POP_STRUC.PSO(par_one).order;
numIons1 = POP_STRUC.PSO(par_one).numIons;
end
...
potentialLattice = ORG_STRUC.constLat;
end
