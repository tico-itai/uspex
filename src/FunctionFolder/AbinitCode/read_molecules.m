...
temper(i,1) = elementID(type);  
for k= 2:N_col
temper(i,k)=tmp(k+shift);
end
if ORG_STRUC.abinitioCode(1)==6  
...
MOLCCORS = bsxfun(@minus, MOLCOORS, mean(MOLCOORS)); 
