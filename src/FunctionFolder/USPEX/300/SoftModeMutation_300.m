...
good1 = 0;
good2 = 0;
POP_STRUC.SOFTMODEParents(SOFT_ID).Softmode_num = f;  
...
POP_STRUC.SOFTMODEParents(SOFT_ID).Softmode_num = 0;  
...
[MUT_LAT, strainMatrix]= lattice_Mutation(MUT_LAT, 0.15);  
end
